...
@AndroidEntryPoint
class FlashFragment : BaseLandFragment<FragmentFlashBinding>(
    FragmentFlashBinding::inflate
) {
            ...
            chipGroup.setOnCheckedStateChangeListener { _, checkedIds ->
                ...
                checkedIds.forEach {
                    when (it) {
                        ...
                        chipSelfFlash.id -> utilityFilters.add(Constants.TAG_SELF_POP)
                    }
                }
                if (searchText.isNotBlank())
                    utilityFilters.add(searchText)
    ...
    private fun setBackground() {
        ...
        binding.flashLayout.background = backgroundBlur
    }
