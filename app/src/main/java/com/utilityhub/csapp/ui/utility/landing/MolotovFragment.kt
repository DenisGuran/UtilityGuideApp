...
@AndroidEntryPoint
class MolotovFragment : BaseLandFragment<FragmentMolotovBinding>(
    FragmentMolotovBinding::inflate
) {
    ...
    private fun setBackground() {
        ...
        binding.molotovLayout.background = backgroundBlur
    }
    ...
    companion object {
        private const val utilityType = Constants.MOLOTOVS_REF
    }
